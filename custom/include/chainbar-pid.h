...
struct ChainbarPIDConfig {
  ...
  double minDegrees = 0.0;   // EDIT to match physical travel.
  double maxDegrees = 90.0;  // EDIT to match physical travel.
};
...
class ChainbarPID {
 public:
  ...
  // Enables control and resets PID history. Target is limited to configured travel.
